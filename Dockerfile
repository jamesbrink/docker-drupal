...
RUN apt-get update && apt-get install -y curl sendmail apache2 git php5 php5-cli php5-curl php5-gd php5-imagick php5-cli php5-mysql mysql-client && rm -rf /var/lib/apt/lists/*
